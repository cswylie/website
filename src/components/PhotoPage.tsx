...
const images = Object.entries(
  import.meta.glob("../images/photo*.{jpg,png}", {
    eager: true,
    import: "default",
  }),
)
...
const PhotoPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] font-Zain p-3">
      ...
      ></div>
      <div
        className="flex justify-center text-3xl font-bold opacity-0 animate-fade-in"
      ...
      <div className="flex justify-center mt-6">
        <div
          className="relative w-full max-w-2xl flex items-center justify-center opacity-0 animate-fade-in"
      ...
      <div
        className="flex justify-center mt-4 space-x-2 opacity-0 animate-fade-in"
